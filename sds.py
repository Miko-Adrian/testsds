...
def get_pubchem_data(chemical_name):
    ...
    base_url = "https://pubchem.ncbi.nlm.nih.gov/docs/pug-rest#section=Synonyms"
...
def hazard_to_symbol(hazard_code):
    ...
    hazard_map = {
        ...
        'H281': {'symbol': '🏺❄', 'name': 'Contains refrigerated gas; may cause cryogenic burns or injury'},
        'H290': {'symbol': '⚡', 'name': 'May be corrosive to metals'},
        'H300': {'symbol': '☠', 'name': 'Fatal if swallowed'},
        'H301': {'symbol': '☠', 'name': 'Toxic if swallowed'},
        'H302': {'symbol': '⚠', 'name': 'Harmful if swallowed'},
        'H304': {'symbol': '⚠', 'name': 'May be fatal if swallowed and enters airways'},
        'H310': {'symbol': '☠', 'name': 'Fatal in contact with skin'},
        'H311': {'symbol': '☠', 'name': 'Toxic in contact with skin'},
        'H312': {'symbol': '⚠', 'name': 'Harmful in contact with skin'},
        'H314': {'symbol': '⚠', 'name': 'Causes severe skin burns and eye damage'},
        'H315': {'symbol': '⚠', 'name': 'Causes skin irritation'},
        'H317': {'symbol': '⚠', 'name': 'May cause an allergic skin reaction'},
        'H318': {'symbol': '⚠👁', 'name': 'Causes serious eye damage'},
        'H319': {'symbol': '⚠👁', 'name': 'Causes serious eye irritation'},
        'H330': {'symbol': '☠', 'name': 'Fatal if inhaled'},
        'H331': {'symbol': '☠', 'name': 'Toxic if inhaled'},
        'H332': {'symbol': '⚠', 'name': 'Harmful if inhaled'},
        'H334': {'symbol': '⚠', 'name': 'May cause allergy or asthma symptoms or breathing difficulties if inhaled'},
        'H335': {'symbol': '⚠', 'name': 'May cause respiratory irritation'},
        'H336': {'symbol': '⚠', 'name': 'May cause drowsiness or dizziness'},
        'H340': {'symbol': '⚠', 'name': 'May cause genetic defects'},
        'H341': {'symbol': '⚠', 'name': 'Suspected of causing genetic defects'},
        'H350': {'symbol': '⚠', 'name': 'May cause cancer'},
        'H351': {'symbol': '⚠', 'name': 'Suspected of causing cancer'},
        'H360': {'symbol': '⚠', 'name': 'May damage fertility or the unborn child'},
        'H361': {'symbol': '⚠', 'name': 'Suspected of damaging fertility or the unborn child'},
        'H362': {'symbol': '⚠', 'name': 'May cause harm to breast-fed children'},
        'H370': {'symbol': '⚠🧠', 'name': 'Causes damage to organs'},
        'H371': {'symbol': '⚠🧠', 'name': 'May cause damage to organs'},
        'H372': {'symbol': '⚠🧠', 'name': 'Causes damage to organs through prolonged or repeated exposure'},
        'H373': {'symbol': '⚠🧠', 'name': 'May cause damage to organs through prolonged or repeated exposure'},
